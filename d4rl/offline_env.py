...
class MixedOfflineEnv(gym.Env):
    def __init__(self, dataset_urls=None, ref_max_score=None, ref_min_score=None, ratio=None, **kwargs):
        super(MixedOfflineEnv, self).__init__(**kwargs)
        self.dataset_urls = self._dataset_urls = dataset_urls
        self.ref_max_score = ref_max_score
        self.ref_min_score = ref_min_score
        self.ratio = ratio
